            ...
            <div className="content2_right">
                ...
                <div className="content2_right_below">
                    ...
                    <div className="content2_right_theloai">
                        <FontAwesomeIcon icon={faGear} size="2xl" style={{color: "#FFD43B",}} />
                        <span className="content2_right_theloai_title">Khoa Học</span>
                        <div className="content2_right_theloai_public_book">
                            <p>Public book: <a href=""> 123 </a> </p>
                        </div>
                    </div>

                    <div className="content2_right_theloai">
                        <FontAwesomeIcon icon={faMoneyCheckDollar} size="2xl" style={{color: "#FFD43B",}} />
                    ...
                    <div className="content2_right_theloai">
                        <FontAwesomeIcon icon={faSchool} size="xl" style={{color: "#FFD43B",}} />
                    ...
                    <div className="content2_right_theloai">
                        <FontAwesomeIcon icon={faBrain} size="2xl" style={{color: "#FFD43B",}} />
                        <span className="content2_right_theloai_title" style={{paddingLeft: "24px",}}>Tâm Lý</span>
                        <div className="content2_right_theloai_public_book">
                            <p>Public book: <a href=""> 123 </a> </p>
                        </div>
                    </div>
                    ...
                    <div className="content2_right_theloai">
                        <FontAwesomeIcon icon={faBook} size="2xl" style={{color: "#FFD43B",}} />
                    ...
                    <div className="content2_right_theloai">
                        <FontAwesomeIcon icon={faBookOpen} size="2xl" style={{color: "#FFD43B",}} />
